...
namespace mercadosuspenso.api.Controllers
{
    ...
    {
        private readonly IVarejistaService service;
        private readonly IVinculoService vinculoService;

        public VarejistaController(IVarejistaService service, IVinculoService vinculoService)
        {
        ...
        [AllowAnonymous]
        [HttpPost]
        [SwaggerOperation(Summary = "Novo cadastro de varejista", Description = "Novo cadastro de varejista pendente de aprovação")]
        ...
        [HttpPut("endereco")]
        [SwaggerOperation(Summary = "Inserir ou alterar endereço", Description = "Altera ou inclui o registro de endereço do varejista")]
        [SwaggerResponse(200, "Sucesso")]
        [SwaggerResponse(400, "Dados inválidos", type: typeof(ProblemDto))]
        [SwaggerResponse(403, "Não permitido", type: typeof(ProblemDto))]
